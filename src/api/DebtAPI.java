    ...
    public static boolean insert(HashMap<String, String> newRecord) throws Exception {
        ...
        if (MySQL.isConnected()) {
            if (
                ...
                String paid = newRecord.get("paid");
                ...
                if (
                    ...
                    int updateDebtStatusCode = MySQL.executeUpdate(
                        "insert into debt(userid, onDate, content, amount, positive, paid)"
                        + "values (" 
                        + userid + ", '"
                        + onDate + "', '"
                        + content + "', "
                    ...
                    insertSuccess = false;
                    throw new Exception("Missing some values in debt record");
                }
            } else {
                insertSuccess = false;
                throw new Exception("Missing some fields in debt record");
            }
        } else {
            insertSuccess = false;
    ...
    public static boolean delete(String id) throws Exception {
        ...
        if (MySQL.isConnected()) {
            ...
            if (oldRecord.isBeforeFirst()) {
                ...
                String oldPaid = Integer.toString(oldRecord.getInt("paid"));

                int totalCash = TotalCashAPI.getTotalCash(oldUserid);

                // Khoi phuc tien cu
                if (oldPaid.trim().equals("0")) {
                ...
                deleteSuccess = false;
                throw new Exception("Cannot retrieve old record from debt table");
            }
    ...
    public static HashMap<String, String> getRecord(String id) throws Exception {
        ...
        if (MySQL.isConnected()) {
            ...
            if (recordInSet.isBeforeFirst()) {
                ...
                record.put("paid", Integer.toString(recordInSet.getInt("paid")));
        ...
        if (MySQL.isConnected()) {
            ...
            if (recordListInSet.isBeforeFirst()) {
                ...
                while (recordListInSet.next()) {
                    ...
                    record.put("paid", Integer.toString(recordListInSet.getInt("paid")));
